...
class getTurbo_Broadcaster_ActionRendererService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['turbo.broadcaster.action_renderer'] = new \Symfony\UX\Turbo\Broadcaster\TwigBroadcaster(($container->privates['turbo.broadcaster.action_renderer.inner'] ?? $container->load('getTurbo_Broadcaster_ActionRenderer_InnerService')), ($container->privates['twig'] ?? $container->getTwigService()), ['App\\Entity\\' => 'broadcast/'], ($container->privates['turbo.id_accessor'] ?? $container->load('getTurbo_IdAccessorService')));
    }
}
